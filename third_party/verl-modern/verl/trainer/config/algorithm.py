...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        adv_estimator_module (Optional[str]): Import path that registers a custom advantage estimator.
        hybrid_dgpo (dict[str, Any]): Settings for a registered hybrid DGPO advantage estimator.
    ...
    adv_estimator_module: Optional[str] = None
    hybrid_dgpo: dict[str, Any] = field(default_factory=dict)
